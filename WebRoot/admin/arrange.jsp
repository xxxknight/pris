...
<html lang="zh-CN">
	<head>
		...
		<link href="<%=basePath%>resources/css/admin/dashboard.css" rel="stylesheet">

		<!-- Just for debugging purposes. Don't actually copy these 2 lines! -->
		<!--[if lt IE 9]><script src="../../assets/js/ie8-responsive-file-warning.js"></script><![endif]-->
		<script src="<%=basePath%>resources/assets/js/ie-emulation-modes-warning.js"></script>
    ...
    ================================================== -->
		...
		<script src="<%=basePath%>resources/assets/js/ie10-viewport-bug-workaround.js"></script>
		...
		<script type="text/javascript"
			src="<%=basePath%>resources/js/admin/dtArrange.js"></script>
	</body>
</html>
